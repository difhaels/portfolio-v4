        ...
        <div className="grid gap-6 text-left md:grid-cols-2">
          <div>
            ...
            <ol class="relative border-s border-gray-700">
              <li class="mb-10 ms-4">
                <div class="absolute -start-1.5 mt-1.5 h-3 w-3 rounded-full border border-gray-900 bg-gray-700"></div>
                <time class="mb-1 text-sm leading-none text-gray-500">
                  2019-2022
                </time>
                <h1 class="text-lg font-semibold text-[#72E2AE]">
          ...
          <div>
            ...
            <ol class="relative border-s border-gray-700">
              <li class="mb-10 ms-4">
                ...
                <h1 class="text-lg font-semibold text-[#72E2AE]">IT Support</h1>
                <h1 className="mb-2 text-base">
